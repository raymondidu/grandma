...
setIsFooterVisible(true);
  ...
  return (
    <div  className=" w-[360px] lg:w-full max-w-[680px] h-auto max-h-[90vh] bg-white rounded-[32px] overflow-scroll relative">
      {/* Header */}
      <div ref={chatRef}>
      ...
      <div className="flex w-full items-end gap-3 sm:gap-4 px-4 pb-6 sm:px-6 sm:pb-8 ">
        ...
        <div className="flex flex-col flex-1">
          ...
          {/* Text Input */}
          {/* <div className="flex h-20 sm:h-14 items-center gap-2.5 px-3 sm:px-4 py-2.5 flex-1 rounded-full border border-solid border-[#dad8df]">
            <Input
              className="border-0 bg-transparent p-0 h-20 font-normal text-[#a2a2a2] text-sm sm:text-base placeholder:text-[#a2a2a2] focus-visible:ring-0 focus-visible:ring-offset-0"
